...
from Catalogo_combis import abrir_catalogo  # Importar la función correcta

def abrir_agregar_combi():
    ventana = Toplevel(root)  # Crear una nueva ventana
...
btn_catalogo = tk.Button(frame, text="Catálogo", command=abrir_catalogo)  # Solo abre cuando se presiona
